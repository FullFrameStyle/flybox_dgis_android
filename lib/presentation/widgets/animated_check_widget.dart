...
class AnimatedCheckWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => AnimatedCheckWIdgetState();
}
...
class AnimatedPathPainter extends CustomPainter {
  ...
  Path _createAnyPath(Size size) {
    return Path()
      ..moveTo(0.21 * size.width, 0.47 * size.height)
      ..lineTo(0.41667 * size.width, 0.65750 * size.height)
      ..lineTo(0.75000 * size.width, 0.32417 * size.height);
  }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.strokeWidth = strokeWidth ?? size.width * 0.085;
